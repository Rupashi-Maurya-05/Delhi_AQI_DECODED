...
CODE_DELHI_AQI_DECODED.ipynb   # Main analysis notebook (with outputs)
...
Open `CODE_DELHI_AQI_DECODED.ipynb` in Google Colab or Jupyter and run all cells sequentially. The notebook is self-contained and includes all preprocessing, modelling, and visualization steps.
